    ...
    <div class="container-dashboard flex">
      <nav class="w-20 bg-black-russian">
        <ul class="flex flex-col items-center pt-4">
          <li>
            <button
              class="btn-nav hover:bg-gray-600 rounded-lg flex justify-center items-center p-4 mb-4"
            >
              <svg
                width="20"
                height="20"
          ...
          <li>
            <button
              class="btn-nav hover:bg-gray-600 rounded-lg flex justify-center items-center p-4"
            >
              <svg
                width="18"
                height="18"
      ...
      <div class="container-component text-white">COMPONENT</div>
    </div>
